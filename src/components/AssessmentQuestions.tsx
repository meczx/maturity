    ...
    <div className="fixed inset-0 bg-gray-900 bg-opacity-95 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            {currentQuestion.options.map((option, index) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    {option === "Yes" && <CheckCircle className="h-5 w-5 text-green-600 mr-3" />}
                    {option === "No" && <XCircle className="h-5 w-5 text-red-600 mr-3" />}
                    {option === "Unsure" && <HelpCircle className="h-5 w-5 text-yellow-600 mr-3" />}
        ...
        <div className="flex items-center justify-center">
          <div className={`inline-flex items-center px-4 py-2 rounded-full text-white font-medium ${currentDomainInfo?.color}`}>
            {currentDomain}
          </div>
        </div>
      </div>
